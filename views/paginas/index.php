    ...
    <?php foreach($ponentes as $ponente) { ?>
        <div <?php aos_animacion(); ?> class="speaker">
            <picture>
                ...
                <img src="img/speakers/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente" class="speaker__imagen" loading="lazy" width="100" height="150">
            </picture>
            ...
            <div class="speaker__informacion">
                ...
                <ul class="speaker__listado-skill">
                    <?php 
