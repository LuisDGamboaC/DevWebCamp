...
<div class="dashboard__contenedor">
            ...
            <tbody class="table__tbody">
                <?php foreach($eventos as $evento) { ?>
                    <tr class="table__tr">
                        ...
                        <!-- *aqui mostramos los nombres de la categoria_id en lugar de sus numeros*/ -->
                        <td class="table__td">
                        ...
                        <td class="table__td--acciones">
                            <a class="table__accion table__accion--editar" href="/admin/eventos/editar?id=<?php echo $evento->id; ?>"> <i class="fa-solid fa-pencil"></i>
                            Editar
                            </a>
    ...
    <?php } else { ?>
        <p href="" class="text-center"> No hay Eventos aún</p>
    <?php }?>   
</div>
